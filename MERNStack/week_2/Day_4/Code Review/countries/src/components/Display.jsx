...
function Display(props) {
    ...
    return (
        <tr>
            ...
            <td>
                <input type="checkbox" checked={props.country.independent} onChange={(e) => {props.updateCountry(props.index) ; setThisC({name:{commun:props.country.name.common},flag:{png:props.country.flags.png}})}}/> Independent
